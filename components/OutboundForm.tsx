          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex justify-between items-center mb-1">
              ...
              {selectedProduct && (
                <button
                  type="button"
                  onClick={() => setQuantity(getStock(selectedProduct.code))}
                  className="text-xs bg-slate-100 hover:bg-slate-200 text-primary font-bold px-2 py-0.5 rounded transition-colors"
                >
                  Max
                </button>
              )}
